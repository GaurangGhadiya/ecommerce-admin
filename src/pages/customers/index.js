  ...
  },
  {
    ...
    renderCell: ({ row }) => {
      return row.balance !== 0 ? (
        <CustomChip rounded size='small' skin='light' color='error' label='Block' />
      ) : (
              ...
              <Grid container spacing={6}>
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    ...
                    <MenuItem value='downloaded'>Block</MenuItem>
                  </CustomTextField>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <CustomTextField
                  ...
                  >
                    ...
                    <MenuItem value='downloaded'>Canada</MenuItem>
                    <MenuItem value='downloaded1'>USA</MenuItem>
                    <MenuItem value='downloaded2'>UK</MenuItem>
                  </CustomTextField>
                </Grid>
              </Grid>
            </CardContent>
